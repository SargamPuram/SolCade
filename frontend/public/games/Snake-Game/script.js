...
const foodSound = new Audio("/games/Snake-Game/music/food.mp3");
const gameOverSound = new Audio("/games/Snake-Game/music/gameover.mp3");
const musicSound = new Audio("/games/Snake-Game/music/music.mp3");
